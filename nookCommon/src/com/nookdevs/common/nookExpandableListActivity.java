...
/**
 * The Class nookExpandableListActivity.
 */
public class nookExpandableListActivity extends ExpandableListActivity {
    ...
    public final void showSoftKeyboard()
    {
        ...
        imm.showSoftInput(getExpandableListView(),InputMethodManager.SHOW_FORCED);
    }
    ...
    {
        InputMethodManager imm = (InputMethodManager) this.getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.hideSoftInputFromWindow(getExpandableListView().getWindowToken(),0);
    }    
